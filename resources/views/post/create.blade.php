    ...
    <body class="bg-light">
        ...
        <div class="container-md my-5">
            <div class="col-xxl-5 col-xl-6 col-lg-8 mx-auto">
                ...
                <form class="dropzone overflow-visible p-0" id="formDropzone" method="POST" action="/post" enctype="multipart/form-data" novalidate>
                    @csrf
                    <input hidden id="file" name="file"/>
                    <div class="form-group mb-3">
                        <label  class="form-label text-muted opacity-75 fw-medium" for="content">Conteúdo</label>
                        <textarea required class="form-control border-2 shadow-none fw-bold p-3" id="content" name="content"></textarea>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div  required class="dropzone-drag-area form-control" id="previews">
                            <div  required class="dz-message text-muted opacity-50" data-dz-message>
